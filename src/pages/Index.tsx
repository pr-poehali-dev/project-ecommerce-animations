        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="profile" className="animate-fade-in">
            <Card className="p-6">
              <div className="flex items-center gap-6 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Администратор</h3>
                  <p className="text-gray-600">admin@shopadmin.ru</p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Заказов обработано</p>
                </div>
          ...
          <TabsContent value="support" className="animate-fade-in">
            <Card className="p-6">
              ...
              <div className="space-y-3">
                {[
                  { id: 1, client: "Иван Петров", issue: "Вопрос по доставке заказа #101", status: "active", time: "Сейчас онлайн" },
                  { id: 2, client: "Мария Сидорова", issue: "Запрос возврата товара", status: "waiting", time: "5 мин назад" },
                  { id: 3, client: "Алексей Иванов", issue: "Технический вопрос по оплате", status: "resolved", time: "1 час назад" },
                ].map((ticket) => (
                  <div 
                    key={ticket.id} 
                    className={`p-4 rounded-lg border-2 transition-all hover:shadow-md cursor-pointer ${
                      ticket.status === 'active' ? 'border-green-200 bg-green-50' :
